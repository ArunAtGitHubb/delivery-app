...
import com.jellysoft.deliveryapp.adapters.CompleteOrderAdapter.OrderViewHolder
import com.jellysoft.deliveryapp.databinding.ItemCompleteOrderlistBinding

class CompleteOrderAdapter(data: ArrayList<ItemOrder>, username: String, from: String) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OrderViewHolder {
        ...
        val view = LayoutInflater.from(parent.context).inflate(layout.item_complete_orderlist, parent, false)
    ...
    inner class OrderViewHolder(itemView: View) : ViewHolder(itemView) {
        var binding: ItemCompleteOrderlistBinding

        init {
            binding = ItemCompleteOrderlistBinding.bind(itemView)
        }
